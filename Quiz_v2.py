...
def do_maths(op_type):
    ...
    print(f"🤔🤔🤔 You are on question number {round_played + 1} out of {max_rounds} 🤔🤔🤔")
    print(answer)
    ...
    if user_answer == answer:
        ...
        quiz_history.append(f"😀😀😀Question {round_played + 1}, The question was {number1} {unit} {number2} and you guessed the correct answer which was {answer} 😀😀😀")
        print(feedback)
        print()
        # this returns "correct so code further down can add +1 to correct_ans"
        return "correct"
    else:
        feedback = f"💩💩💩 You didn't Guess the answer: {answer} 💩💩💩"
        quiz_history.append(f"💩💩💩Question {round_played + 1}, The question was {number1} {unit} {number2} the correct answer was {answer} BUT you guessed {user_answer} 💩💩💩")
        print(feedback)
        print()
...
while round_played + 1 <= max_rounds:
...
if round_played > 1:
    ...
    if see_history.lower() == "yes" or see_history.lower() == "y":
        print("🪄🪄🪄 Quiz History 🪄🪄🪄")
        print(f"You got {correct_ans} out of {round_played - 1} questions correct!\n")
        print()
